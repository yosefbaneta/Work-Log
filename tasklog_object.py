                    ...
                    if self.sum_range1<=self.sum_range2:## this code checks if the start date is less than the end date
                        ...
                        for item in file[::2]:
                            ...
                            if self.se!='date':## making sure the date heading is skipped
                                ...
                                if str(self.se_sum)>=str(self.sum_range1) and str(self.se_sum)<=str(self.sum_range2):                                  self.exist='yes'## to be used to check if the item we are searching for exists

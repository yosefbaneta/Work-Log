...
class Look_up:## this class is used to  search previous logs
    ...
    def By_range(self):  ## this method searches the a log by using a date range
        back='this page is not availabel'## i created this string to be used when we choose to go back on the first item
            ...
            if self.sum_range1<=self.sum_range2:## this code checks if the start date is less than the end date
                ...
                for item in file[::2]:
                    ...
                    if self.se!='date':## making sure the date heading is skipped
                        ...
                        if str(self.se_sum)>=str(self.sum_range1) and str(self.se_sum)<=str(self.sum_range2) :## checking if the date is in the range
                            
                            self.exist='yes'## to be used to check if the item we are searching for exists
                            
                            if self.to_li[2].lower()=='skip':## skipping the note for the one's that say skip 
                ...
                if str(self.se)==self.searchdate :
                    ...
                    if self.to_li[2].lower()=='skip':
                        ...
                        try:
                            ...
                            print('\n ..ooops! the bbbpage is not availabel!\n')
                            break
        ...
        while True:
            ...
            for item in file[::2]:
                ...
                if self.to_li[0]!='task_name':
                    if str(self.se)==self.searchname or str(self.st_note)==self.searchname or self.searchname in str(self.st_note):
                        self.exist='yes'
    ...
    def Edit_task(self):
        ...
        while True:
                try:
                    ...
                    print('\n\n....oops. your input was invalid.\n please try again.\n\n')
                    continue
                if str(self.choice)=='1' or str(self.choice)=='2' or str(self.choice)=='3' or str(self.choice)=='4':
                    break
                else:
                    print('\n\n...oops! your input was invalid.\n please try again\n\n')
                    continue

    ...
    if str(selection)=='2':
        ...
        while True:
                try:
                    ...
                    check1=bool(str(lookup_selection)=='1')
                    check2=bool(str(lookup_selection)=='2')
                    check3=bool(str(lookup_selection)=='3')
                    check4=bool(str(lookup_selection)=='4')
                    check5=bool(str(lookup_selection)=='5')


                    if check1==True or check2==True or check3==True or check4==True or check5==True:
